// components/organisms/CartSidebar.jsx
...
const CartSidebar = ({ onClose }) => {
  ...
  return (
    <div className="fixed top-0 right-0 w-full max-w-sm h-full bg-white shadow-lg z-50 transition-transform duration-300 flex flex-col">
      {/* Header */}
          ...
          <div key={item.id} className="flex items-start gap-3 border-b pb-4">
            ...
            <div className="flex-1 space-y-1">
              ...
              <div className="flex justify-between items-start">
                ...
                <button className="text-xs text-primary hover:font-bold hover:underline">
                  Hapus
                </button>
              </div>
